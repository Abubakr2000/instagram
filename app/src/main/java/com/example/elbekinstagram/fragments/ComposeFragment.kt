...
{
    val CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE = 103
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set onclickListener and setup logic
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Log.e(MainActivity.TAG, "Error while taking a picture")
                Toast.makeText(requireContext(),"Error in capturing picture", Toast.LENGTH_SHORT).show()

            }
        }

        view.findViewById<Button>(R.id.btnTakePicture).setOnClickListener() {
            // Launch camera to let user to take picture
            onLaunchCamera()
        }
    }

    // send a post object to our post
